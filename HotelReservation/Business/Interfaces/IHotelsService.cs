...
namespace Business.Interfaces
{
    public interface IHotelsService
    {
        ...
        Task<PageInfo<HotelModel>> GetFilteredHotels(string userId, DateTime checkInDate, DateTime checkOutDate, string country, string city, Pagination hotelPagination);
